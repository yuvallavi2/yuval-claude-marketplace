...
<!--
  This file is the canonical source of truth for persona content.
  It is injected into each project's CLAUDE.md by /init (first run)
  and refreshed into existing projects by /refresh-persona (future).

  When CLAUDE.md is updated via the init skill, the content of this file
  replaces everything between the <!-- PERSONA:START --> and
  <!-- PERSONA:END --> markers in the template.

  Edit this file freely. Do not edit the markers themselves.
-->
